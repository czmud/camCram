...
async function onPageLoad(){
	let protectionsResponse = await fetch("/api/van/protections-in-van");
	protectionsInVans = await protectionsResponse.json();
	let belayDevicesResponse = await fetch("/api/van/belay-devices-in-van");
	belayDevicesInVans = await belayDevicesResponse.json();
	let drawsResponse = await fetch("/api/van/draws-in-van");
...
async function addProtectionToVan( protectionId ){
	...
	let response = await fetch("/api/van/add-protection-to-van", { method:'POST', body: formData });
...
async function removeProtectionFromVan( protectionsInVanId ){
	...
	let response = await fetch("/api/van/remove-protection-from-van", { method: 'PUT', body: formData })
...
async function addBelayDeviceToVan( belayDeviceId ){
	...
	let response = await fetch("/api/van/add-belay-device-to-van", { method:'POST', body: formData });
...
async function removeBelayDeviceFromVan( belayDevicesInVanId ){
	...
	let response = await fetch("/api/van/remove-belay-device-from-van", { method: 'PUT', body: formData })
...
async function addDrawToVan( drawId ){
	...
	let response = await fetch("/api/van/add-draw-to-van", { method:'POST', body: formData });
...
async function removeDrawFromVan( drawsInVanId ){
	...
	let response = await fetch("/api/van/remove-draw-from-van", { method: 'PUT', body: formData })
